...
class TafelAnalyzer:
    ...
    def fit_polarization_data(self, E, i, W=95, w_ac=0.05, gamma_bounds=(1.5, 5)):
        ...
        # Refined bounds for realistic fitting scenario
        bounds = (
        ...
        # Curve fitting with higher iterations
        params, _ = curve_fit(
        ...
        i_fit = self._mixed_control_fit(E_fit, *params)
        residuals = i_density - self._mixed_control_fit(E, *params)
